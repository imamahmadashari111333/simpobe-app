...
@if(auth()->user()->level == 1)
    ...
    <x-dropdown-link href="{{ route('prodi.index') }}"> 
        Data Prodi 
    </x-dropdown-link>
@endif
...
<!-- <x-dropdown-link href="{{ route('cpl-sndikti.index') }}"> CPL SNDIKTI </x-dropdown-link> -->
...
<div class="hidden sm:flex sm:items-center sm:ms-6">
    <x-dropdown align="right" width="48">
        ...
        <x-slot name="content">
            ...
            <!-- <x-dropdown-link href="{{ route('krs.index') }}"> KRS Mahasiswa </x-dropdown-link> -->
            
            <div class="border-t border-gray-200"></div>

            <x-dropdown-link href="{{ route('penilaian.import') }}"> 
                <span class="text-blue-600 font-semibold font-bold">Import Nilai Excel</span> 
            </x-dropdown-link>
